...
public class TstKeyStoreActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_tst);
    ...
    public void createNewKeys(View view) {
        ...
        KeyguardManager k = (KeyguardManager) this.getSystemService(Context.KEYGUARD_SERVICE);
        boolean b0 = k.isKeyguardSecure();
        boolean b1 = k.isKeyguardLocked();
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        try {
                            ...
                            Toast.makeText(TstKeyStoreActivity.this,
